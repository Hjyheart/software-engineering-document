...
\subsection{引言}
\subsubsection{编写目的}
编写本计划的目的是把在“鲜活”项目的开发过程中对各项工作任务的负责人员、开发进度、经费预算、硬件和软件资源条件等问题所作的安排用文档的形式记载下来，以便根据本计划开展和检查项目开发工作，保证项目开发成功。
\subsubsection{参考资料}
\href{http://docs.spring.io/spring-data/jpa/docs/2.0.0.M1/reference/html/}{spring} 、
\href{http://docs.spring.io/spring-boot/docs/2.0.0.BUILD-SNAPSHOT/reference/htmlsingle/}{spring-boot}
\subsubsection{项目背景}
